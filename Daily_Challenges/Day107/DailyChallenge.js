...
// Intuition
// The problem asks us to find the largest combination of numbers in the list candidates whose AND is greater than 0 so
// if all the numbers in a combination has a ith bit set , it means their AND will surely be greater than 0 , so the problem
// breaks down to find the largest combination of numbers in the list candidates where a specific bit position (from 0 to 31)
// is set to 1. In other words, we want to find the maximum number of elements in candidates that share a common bit position set to 1.
